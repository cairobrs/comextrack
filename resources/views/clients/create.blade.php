                    ...
                    <form method="POST" action="{{ route('clients.store') }}">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="email" class="block mt-1 w-full" type="text" name="email" :value="old('email')" placeholder="Separe múltiplos e-mails por vírgula. Ex: operacional@cliente.com, financeiro@cliente.com" />
                                <x-input-error :messages="$errors->get('email')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="nome_responsavel" :value="__('Nome do Responsável')" />
                                <x-text-input id="nome_responsavel" class="block mt-1 w-full" type="text" name="nome_responsavel" :value="old('nome_responsavel')" placeholder="Exemplo: Maria Souza" />
                            ...
                            <div>
                                ...
                                <x-text-input id="telefone_responsavel" class="block mt-1 w-full" type="text" name="telefone_responsavel" :value="old('telefone_responsavel')" placeholder="(34) 99999-9999" />
